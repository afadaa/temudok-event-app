...
import { AlertCircle, CheckCircle2, Clock, Download, Image as ImageIcon, Loader2, Mail, Search, User, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className={`rounded-2xl p-4 ${approved ? 'bg-emerald-50 text-emerald-700' : rejected ? 'bg-red-50 text-red-700' : 'bg-amber-50 text-amber-700'}`}>
        ...
        <p className="text-sm font-bold leading-relaxed">
          {approved
            ? 'Data Anda sudah divalidasi admin. Kartu Panitia sudah dapat dicetak.'
            : rejected
