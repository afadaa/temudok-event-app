...
router.get('/panitia/status', PublicController.getPanitiaStatus);
router.post('/panitia/register', PublicController.registerPanitia);
router.post('/panitia/photo', PublicController.uploadPanitiaPhoto);
